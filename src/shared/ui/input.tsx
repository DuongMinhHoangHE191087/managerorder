  ...
  ({ className, type, error, ...props }, ref) => {
    return (
      <input
        ...
        type={type}
        className={cn(
          "flex h-10 w-full rounded-[1rem] border bg-[rgba(255,255,255,0.88)] px-3 py-2 text-[13px] font-medium text-[var(--fg-base)] shadow-sm transition-all file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-[var(--fg-muted)]/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50",
          error
