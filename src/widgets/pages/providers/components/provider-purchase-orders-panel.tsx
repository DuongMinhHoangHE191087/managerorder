    ...
    <div className="app-card overflow-hidden border border-[var(--border-soft)] bg-[rgba(255,255,255,0.94)] shadow-[0_16px_38px_rgba(15,23,42,0.05)]">
      ...
      {isLoading ? (
        ...
        <div className="py-12 text-center">
          ...
          <p className="text-[13px] text-[var(--fg-muted)]">Chưa có đơn nhập hàng nào</p>
          <p className="mt-1 text-[11px] text-[var(--fg-muted)]">
            Tạo đơn nhập để ghi nhận chi phí và theo dõi thanh toán.
          </p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="mb-3 flex items-center gap-4">
                  <div className="flex-1">
                    <div className="mb-1.5 flex justify-between text-[10px] font-bold uppercase tracking-wider">
                      <span className="text-[var(--fg-muted)]">Thanh toán</span>
                ...
                <div className="flex items-center justify-between gap-3 text-[12px]">
                  <div className="text-[var(--fg-muted)]">{order.items.length} dòng hàng</div>
                  {remaining > 0 ? (
                    <button
                      type="button"
                    ...
                    >
                      Thanh toán {formatMoney(remaining)}
                    </button>
                  ) : (
                    <span className="font-bold text-emerald-500">Đã thanh toán đủ</span>
                  )}
                </div>
              </div>
            );
