...
export function ReminderConfigManager() {
  ...
  if (isLoading) {
    return (
      <div className="py-8 text-center text-[13px] text-[var(--fg-muted)] animate-pulse">
            ...
            return (
              ...
              >
                <div className="mb-2 flex items-center justify-between">
                  <span className={enabled ? "text-2xl font-black text-[var(--accent)]" : "text-2xl font-black text-[var(--fg-muted)]"}>
                    {day.label}
                  </span>
                  <div
      ...
      <div className="flex items-center justify-between rounded-2xl border border-[var(--border-soft)] bg-white p-4">
        <div className="flex items-center gap-3">
          {config.auto_send ? (
            ...
            <BellOff className="size-5 text-[var(--fg-muted)]" />
          )}
          <div>
