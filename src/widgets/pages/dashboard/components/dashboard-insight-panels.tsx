...
function getSlotState(item: DashboardProductSlot) {
  ...
  const statusText = isFull ? "ĐẦY" : isAlmostFull ? "SẮP ĐẦY" : "TRỐNG";
    ...
    <div className="grid grid-cols-1 gap-6 lg:col-span-2">
      <div className="app-card flex min-w-0 flex-col overflow-hidden border border-[var(--border-soft)] shadow-[0_18px_44px_rgba(15,23,42,0.05)] transition-all hover:shadow-[0_22px_52px_rgba(15,23,42,0.08)]">
        <div className="border-b border-[var(--border-soft)] bg-[var(--bg-app)]/50 p-5 backdrop-blur-sm">
          <h3 className="text-[15px] font-bold tracking-tight text-[var(--fg-base)]">Trạng thái kho sản phẩm</h3>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1 overflow-hidden">
                  ...
                  <p className="text-[11px] font-medium text-[var(--fg-muted)]">Auto-renew active</p>
                </div>
      ...
      <div className="app-card flex min-w-0 flex-col overflow-hidden border border-[var(--border-soft)] shadow-[0_18px_44px_rgba(15,23,42,0.05)] transition-all hover:shadow-[0_22px_52px_rgba(15,23,42,0.08)]">
        <div className="border-b border-[var(--border-soft)] bg-[var(--bg-app)]/50 p-5 backdrop-blur-sm">
          <h3 className="text-[15px] font-bold tracking-tight text-[var(--fg-base)]">Doanh thu theo sản phẩm</h3>
          <p className="mt-0.5 text-[12px] text-[var(--fg-muted)]">Top hiển thị ({timeShortLabel})</p>
        </div>
