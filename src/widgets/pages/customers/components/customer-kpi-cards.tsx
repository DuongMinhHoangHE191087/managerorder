  ...
  return (
    <StaggerContainer delayChildren={0.2} staggerDelay={0.1} className="grid gap-6 md:grid-cols-3 mb-6">
      <StaggerItem>
        <GlassHoverCard className="flex flex-col gap-2 rounded-ios p-6 shadow-sm h-full bg-white border border-[var(--border-soft)]">
          <div className="flex justify-between items-start">
            <p className="text-[var(--fg-muted)] text-[11px] font-bold uppercase tracking-wider">Tổng khách hàng</p>
      ...
      <StaggerItem>
        <GlassHoverCard className="flex flex-col gap-2 rounded-ios p-6 shadow-sm h-full bg-white border border-[var(--border-soft)]">
          <div className="flex justify-between items-start">
            <p className="text-[var(--fg-muted)] text-[11px] font-bold uppercase tracking-wider">Khách sỉ & Đại lý</p>
      ...
      <StaggerItem>
        <GlassHoverCard className="flex flex-col gap-2 rounded-ios p-6 shadow-sm h-full bg-white border border-[var(--border-soft)]">
          <div className="flex justify-between items-start">
            <p className="text-[var(--fg-muted)] text-[11px] font-bold uppercase tracking-wider">Tổng công nợ</p>
