...
export const InventoryPageHeader = React.memo(function InventoryPageHeader({
  ...
  return (
    <div className="mb-2 mt-2 flex flex-col gap-4 rounded-[1.2rem] border border-[var(--border-soft)] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(246,250,244,0.84))] px-5 py-5 shadow-[0_18px_44px_rgba(15,23,42,0.05)] md:flex-row md:items-center md:justify-between">
      <div>
        <h2 className="text-3xl font-black tracking-tight text-[var(--fg-base)]">Quản lý kho hàng</h2>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-[1rem] border border-[var(--border-soft)] bg-white px-4 py-2 text-[13px] font-bold text-[var(--fg-base)] shadow-sm transition-all hover:shadow-md active:scale-[0.98]"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-[1rem] border border-amber-500/30 bg-amber-500/10 px-4 py-2 text-[13px] font-bold text-amber-500 shadow-sm transition-all hover:bg-amber-500/20 active:scale-[0.98]"
        >
