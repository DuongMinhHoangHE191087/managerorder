...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/inventory", label: "Kho hàng", icon: Boxes },
      { href: "/customers", label: "Khách hàng", icon: Users },
      { href: "/providers", label: "Nhà cung cấp", icon: ShieldCheck },
  ...
  },
  {
    label: "Premium",
    items: [
      { href: "/premium/accounts", label: "Tài khoản", icon: Package },
      { href: "/premium/subscriptions", label: "Thuê bao", icon: ClipboardList },
      { href: "/premium/services", label: "Dịch vụ", icon: Settings2 },
      { href: "/premium/renewals", label: "Gia hạn", icon: CalendarDays },
      { href: "/premium/migrations", label: "Chuyển đổi", icon: ChevronRight },
    ],
  },
  {
    label: "Tiện ích",
    items: [
      ...
      { href: "/activity-logs", label: "Nhật ký", icon: ClipboardList },
      { href: "/short-links", label: "Link rút gọn", icon: Link2 },
      { href: "/trash", label: "Thùng rác", icon: Trash2 },
      { href: "/settings", label: "Cài đặt", icon: Settings2 },
      { href: "/settings/bot", label: "Quản lý bot", icon: Bot },
    ],
  },
];
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span className="text-sm font-semibold text-[var(--fg-base)]">Tìm nhanh</span>
