                  ...
                  <ActionMenu
                    items={[
                      ...
                      },
                      {
                        ...
                        onClick: () => void copyToClipboard(migration.id, "Đã sao chép ID migration"),
                        dividerBefore: true,
                      },
                      {
                        label: "Sao chép subscription",
                        icon: <Copy className="size-4" />,
                        onClick: () => void copyToClipboard(migration.subscription_id, "Đã sao chép ID subscription"),
                      },
                    ]}
                  />
                </div>
