  ...
  return (
    <>
      ...
      <DeferredSettingsCard
        ...
        description="Chọn sản phẩm và link hiển thị trên trang lỗi, trang hết hạn và landing public."
        rows={6}
      >
        <SalesLandingManager />
      </DeferredSettingsCard>
      ...
      <DeferredSettingsCard
        ...
        description="Tuỳ chỉnh % giảm giá CTV/VIP khi tạo đơn nhập hàng nhà cung cấp"
        rows={3}
      >
      ...
      <DeferredSettingsCard
        title="Cấu hình công ty & hoá đơn gốc"
        description="Tạo thông tin mặc định khi in hoá đơn và tạo QR thanh toán"
        rows={6}
      >
