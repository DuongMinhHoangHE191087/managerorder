      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-[14px] font-bold text-amber-800 mb-1">
            {vi.customers.duplicateWarning.title(duplicates.length)}
          </h4>
          <p className="text-[12px] text-amber-700 mb-3">
            {vi.customers.duplicateWarning.description}
          </p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-[var(--fg-muted)]">
                    {dup.matchType === "name" && vi.customers.duplicateWarning.similarName((dup.similarity * 100))}
                    {dup.matchType === "contact" && vi.customers.duplicateWarning.duplicateContact(dup.matchValue ?? vi.common.notAvailable)}
                    {dup.matchType === "both" && vi.customers.duplicateWarning.duplicateBoth(dup.matchValue ?? vi.common.notAvailable)}
                  </p>
                </div>
                <a
                  ...
                  title={vi.customers.duplicateWarning.viewDetails}
                >
          ...
          <div className="flex gap-2">
            ...
            >
              {vi.customers.duplicateWarning.cancel}
            </button>
            <button
              type="button"
              onClick={onContinue}
            ...
            >
              {isSubmitting ? vi.customers.duplicateWarning.creating : vi.customers.duplicateWarning.continue}
            </button>
          </div>
        </div>
      </div>
