...
export function LoginGooglePanel({ redirectUrl, onErrorChange }: LoginGooglePanelProps) {
  ...
  return (
    <div>
      <Button
        ...
        size="lg"
        isLoading={isLoading}
        className="w-full gap-3 font-semibold shadow-sm border-[var(--border-strong)]"
      >
        {!isLoading && (
      ...
      <p className="mt-4 text-center text-xs text-[var(--fg-muted)]">
        Su dung tai khoan Google da duoc cap quyen truy cap
      </p>
    </div>
  );
}
