    ...
    <div className="bg-white text-black p-8 sm:p-12 w-full max-w-4xl mx-auto shadow-sm min-h-[A4] print:shadow-none print:w-full font-sans border print:border-none relative">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8 text-sm">
        <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
          <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">Kênh bán</p>
          <p className="font-semibold text-gray-800">{salesChannelName}</p>
        </div>
        <div className="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
          <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-1">Nguồn tiền</p>
          <p className="font-semibold text-gray-800">{paymentSourceName}</p>
        </div>
      </div>
