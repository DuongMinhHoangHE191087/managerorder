                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2 text-[11px] font-medium text-[var(--fg-muted)]">
                      <span className="inline-flex items-center gap-1 rounded-full border border-[var(--border-soft)] bg-white/80 px-2 py-0.5">
                        ...
                        {order.salesChannelName || "Chưa gắn kênh bán"}
                      </span>
                      <span className="inline-flex items-center gap-1 rounded-full border border-[var(--border-soft)] bg-white/80 px-2 py-0.5">
                        <Wallet className="size-3 text-emerald-500" />
                        {order.paymentSourceName || "Chưa gắn nguồn tiền"}
                      </span>
                    </div>
                  </div>
                        ...
                        <div className="mt-0.5 flex items-center gap-2">
                          ...
                          {total > paid ? (
                            <span className="whitespace-nowrap text-[10px] font-bold text-[var(--danger)]">
                              Công nợ {formatMoney(order.balance_due_vnd ?? total - paid)}
                            </span>
                          ) : (
        ...
        <div className="flex items-center justify-between gap-4 border-t border-[var(--border-soft)] bg-[rgba(255,255,255,0.88)] px-6 py-3.5">
          <div className="flex items-center gap-3 overflow-x-auto pb-1 sm:pb-0">
            ...
            <span className="hidden whitespace-nowrap border-l border-[var(--border-soft)] pl-3 text-[12px] font-medium text-[var(--fg-muted)] lg:inline">
              Kết quả: <strong className="text-[var(--fg-base)]">{(pageIndex * pageSize) + 1}â€“{Math.min((pageIndex + 1) * pageSize, totalElements)}</strong> / {totalElements}
            </span>
          </div>
