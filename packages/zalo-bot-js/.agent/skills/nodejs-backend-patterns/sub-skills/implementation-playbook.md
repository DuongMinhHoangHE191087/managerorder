...
```
src/
Γö£ΓöÇΓöÇ controllers/     # Handle HTTP requests/responses
Γö£ΓöÇΓöÇ services/        # Business logic
Γö£ΓöÇΓöÇ repositories/    # Data access layer
Γö£ΓöÇΓöÇ models/          # Data models
Γö£ΓöÇΓöÇ middleware/      # Express/Fastify middleware
Γö£ΓöÇΓöÇ routes/          # Route definitions
Γö£ΓöÇΓöÇ utils/           # Helper functions
Γö£ΓöÇΓöÇ config/          # Configuration
ΓööΓöÇΓöÇ types/           # TypeScript types
```
